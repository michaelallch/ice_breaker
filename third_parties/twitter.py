...
def scrape_user_tweets(username, num_tweets=5):
    """Scrapes a Twitter user's original tweets (i.e. not retweets or replies) and returns them as a list of dictionnaries.
    Each dictionnary has three fields: "time_posted" (relative to now), "text" and "url".
    """
    tweets = api.user_timeline(scree_name=username, count=num_tweets)
